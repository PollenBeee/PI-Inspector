...
public class SmaliLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"LBRACK", "RBRACK", "LPAREN", "RPAREN", "LBRACE", "RBRACE", "COLON", 
			"ASSIGN", "DOT", "SUB", "COMMA", "SLASH", "LT", "GT", "ARROW", "SEMI", 
			"PROLOGUE", "METHOD_DIRECTIVE", "METHOD_END_DIRECTIVE", "CLASS_DIRECTIVE", 
			"SOURCE_DIRECTIVE", "IMPLEMENTS_DIRECTIVE", "SUPER_DIRECTIVE", "FIELD_DIRECTIVE", 
			"REGISTERS_DIRECTIVE", "LOCALS_DIRECTIVE", "PARAM_DIRECTIVE", "LINE_DIRECTIVE", 
			"CATCH_DIRECTIVE", "CATCHALL_DIRECTIVE", "ANNOTATION_DIRECTIVE", "ANNOTATION_END_DIRECTIVE", 
			...
			"BRIDGE", "DECLARED_SYNCHRONIZED", "VOLATILE", "STRICTFP", "VARARGS", 
			"NATIVE", "OP_NOP", "OP_MOVE", "OP_MOVE_FROM16", "OP_MOVE_16", "OP_MOVE_WIDE", 
			...
			"OP_IF_LE", "OP_IF_EQZ", "OP_IF_NEZ", "OP_IF_LTZ", "OP_IF_GEZ", "OP_IF_GTZ", 
			"OP_IF_LEZ", "OP_AGET", "OP_AGET_WIDE", "OP_AGET_OBJECT", "OP_AGET_BOOLEAN", 
			"OP_AGET_BYTE", "OP_AGET_CHAR", "OP_AGET_SHORT", "OP_APUT", "OP_APUT_WIDE", 
			"OP_APUT_OBJECT", "OP_APUT_BOOLEAN", "OP_APUT_BYTE", "OP_APUT_CHAR", 
			...
			"OP_IPUT_OBJECT", "OP_IPUT_BOOLEAN", "OP_IPUT_BYTE", "OP_IPUT_CHAR", 
			...
			"OP_SPUT_OBJECT", "OP_SPUT_BOOLEAN", "OP_SPUT_BYTE", "OP_SPUT_CHAR", 
			"OP_SPUT_SHORT", "OP_INVOKE_VIRTUAL", "OP_INVOKE_SUPER", "OP_INVOKE_DIRECT", 
			"OP_INVOKE_STATIC", "OP_INVOKE_INTERFACE", "OP_INVOKE_VIRTUAL_RANGE", 
			...
			"NULL_LITERAL", "CHAR_LITERAL", "STRING_LITERAL", "IDENTIFIER", "CHARACTER", 
			"WS", "LINE_COMMENT", "SimpleName", "SimpleName2", "ExponentPart", "EscapeSequence", 
